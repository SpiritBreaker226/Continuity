...
<title>Our Store - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- InstanceEndEditable -->
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
              ...
              <h1><!-- InstanceBeginEditable name="h1Title" -->Our Store<!-- InstanceEndEditable --></h1>
          	</div><!-- end of Header -->
            <div class="customContent" id="divBasicContent">
                <!-- InstanceBeginEditable name="BasicContent" -->
                 <div class="divPageTitle" align="left">
                	<label class="lblPageTitle">Our Store</label>
                </div>
				<div class="divPageSubTitle">
                  	<label class="lblContinuityColor lblFontSize12 lblFontBold">My Continuity Plans</label>
                </div>
				<div class="divStoreItemContainer customContainer">
					<div class="divStoreItemContent customContent">
						<a href="Solutions.php?section=Solutions#Basic" class="lblFontSize9 lblEnterColor aUnderline"><img src="images/BasicPRGPRICE.jpg" alt="Basic Edition Pricing" width="260" height="294" /></a>
					</div>
					<div class="divStoreItemNavigation customNavigation">
						<a href="Solutions.php?section=Solutions#Standard" class="lblFontSize9 lblEnterColor aUnderline"><img src="images/StandardPRGPRICE.jpg" alt="Standard Edition Pricing" width="260" height="294" /></a>
					</div>
					<div class="divStoreItemThridContent customThridContent">
						<a href="Solutions.php?section=Solutions#Enter" class="lblFontSize9 lblEnterColor aUnderline"><img src="images/EnterprisePRGPricing.jpg" alt="Enterprise Edition Pricing" width="260" height="294" /></a>
					</div>
					<div class="divStoreItemFooter customFooter"></div>
				</div>
                <!-- InstanceEndEditable -->
            </div>
