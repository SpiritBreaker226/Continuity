...
<title>News &amp; Media - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- InstanceEndEditable -->
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
              ...
              <h1><!-- InstanceBeginEditable name="h1Title" -->News &amp; Media<!-- InstanceEndEditable --></h1>
          	</div><!-- end of Header -->
            <div class="customContent" id="divBasicContent">
                <!-- InstanceBeginEditable name="BasicContent" -->
	                <div class="divPageTitle" align="left">
                        <label class="lblPageTitle">Our Media</label>
                    </div>
                    <div class="divPageSubTitle" align="left">
                    	<label class="lblContinuityColor lblFontSize12 lblFontBold">News</label>
                    </div>
                    <div>
						<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="275" height="250" title="Reduce Video">
  <param name="movie" value="FlashVideos/ysb.swf" />
  <param name="quality" value="high" />
  <embed src="FlashVideos/ysb.swf" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="275" height="250"></embed>
  </object>
  				</div>
                <!-- InstanceEndEditable -->
            </div>
