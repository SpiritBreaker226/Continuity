...
<title>Home Recovery Planning - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- InstanceEndEditable -->
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
              ...
              <h1><!-- InstanceBeginEditable name="h1Title" -->Home Recovery Planning<!-- InstanceEndEditable --></h1>
          	</div><!-- end of Header -->
            <div class="customContent" id="divBasicContent">
                <!-- InstanceBeginEditable name="BasicContent" -->
                <div align="left">
                	<a href="http://homerecovery.ca" target="_blank"><img src="images/Homerecoverytop.jpg" alt="Home Recovery Planning" width="894" height="232" /></a>
                    <br /><br />
                    <label class="lblHomeColor lblFontBold">Disaster happen everyday</label><label class="lblFontSize10">, every home and business owner needs to consider the consequences of not protecting your home or business. You have spent a lot of time and hard earned money to purchase a home, or build a business. With that said, it is important to understand the need to take the time to create a plan to protect what you value so much.
                    <br /><br />
                    <strong>Home Recovery Planning - A Division of Continuity Inc.</strong> has developed program that will provide you with the simple steps to protect your home and business. This plan will ensure you are able to survive any disaster event that could potentially have an impact on your home or business and help you recovery as quickly and effectively as possible.</label>
                    <br /><br />
                </div>
                <div align="right">
                	<a href="http://homerecovery.ca" target="_blank" class="aUnderline lblFontBold">Go to HomeRecovery.ca > ></a>
                </div>
                <div align="left">
                	
                </div>
                <div class="customContainer divHomeRecContainer">
                	<div class="customHeader divHomeRecHeader" id="divHomeHeaderStep1" align="left">
                    	<img src="images/HRLEFT1.jpg" alt="" width="208" height="72" />
                        <a href="#" onmouseout="changeImage('imgHomeInventory','images/HR1out.jpg')" onmouseover="changeImage('imgHomeInventory','images/HR1over.jpg')">
                        	<img src="images/HR1out.jpg" alt="Step 1: Create A Home Inventory" width="587" height="72" id="imgHomeInventory" />
                        </a>
                    </div>
                	<div class="customContent divHomeRecContent lblBasicColor">
                        <label>&gt; Photo Documentation Of Contents
                        <br /><br />
                        &gt; Video Walkthrough of Home
                        <br /><br />
                        &gt; Access To Files On-Line
                        <br /><br />
                        &gt; Request For Duplicate of Inventory
                        <br /><br />
                        &gt; Update &amp; Maintain Home Inventory</label>
                    </div>
                    <div class="customNavigation divHomeRecNavigation">
                    	<label><span class="lblBasicColor lblFontBold">A Home Inventory</span> provides a professional, reliable, third-party home  inventory designed to maximize your claim as well as making the claim process stress free. Having an inventory of all items in and around your home is an important part of maintaining control over your home ownership. 
       					<br /><br />
                        <span class="lblBasicColor lblFontBold">First of all</span>, in the event of a total loss at your home, would you be able to identify all of the items that you lost in the event?
       					<br /><br />
                        <span class="lblBasicColor lblFontBold">Secondly</span>, a comprehensive home inventory is important should you ever have an insurance loss. Insurance Companies require information about the circumstance of your claim, and detailed documentation of your home's contents as evidence. This will justify the amount you are claiming.</label>
                    </div>
                    <div class="customFooter divHomeRecFooter">
                    	<a href="http://homerecovery.ca/Pages/homeinventory.html" target="_blank" class="aUnderline lblFontBold">Find Our More > ></a>
                    </div>
                </div>
                <div class="customContainer divHomeRecContainer">
                	<div class="customHeader divHomeRecHeader" id="divHomeHeaderStep2" align="left">
                    	<img src="images/HRLEFT2.jpg" alt="" width="208" height="72" />
                        <a href="#" onmouseout="changeImage('imgFamilyPlan','images/HR2out.jpg')" onmouseover="changeImage('imgFamilyPlan','images/HR2over.jpg')">
                        	<img src="images/HR2out.jpg" alt="Step 2: Create A Family Emergency Plan" width="587" height="72" id="imgFamilyPlan" />
                       </a>
                    </div>
                	<div class="customContent divHomeRecContent lblContinuityColor">
                        <label>&gt; Family Emergency Contact Numbers
                        <br /><br />
                        ...
                        <br /><br />
                        &gt; General Disaster Response Plans</label>
                    </div>
                    <div class="customNavigation divHomeRecNavigation">
                    	<label><span class="lblContinuityColor lblFontBold">A Family Emergency Plan</span> provides you and your family know what to do in case of an emergency. Every Canadian household needs an emergency plan. It will take you about 20 minutes to complete your personalized plan. 
       					<br /><br />
      					<span class="lblContinuityColor lblFontBold">First of all</span>, you will need to think about: Safe exits from home and neighborhood, Meeting places to reunite with family or roommates,Designated person to pick up children should you be unavailable, Contact persons close-by and out-of-town, Health information, Place for your pet to stay, Risks in your region, Location of your fire extinguisher, water valve, electrical box, gas valve and floor drain
      					<br /><br />
                        <span class="lblContinuityColor lblFontBold">Secondly</span>, it will provide your family with a basic emergency response plans that will give you the peace of mind to know that in the event of a disaster, all of your family members will know what to do.</label>
                    </div>
                    <div class="customFooter divHomeRecFooter">
                    	<a href="http://homerecovery.ca/Pages/familyplan.html" target="_blank" class="aUnderline lblFontBold">Find Our More > ></a>
                    </div>
                </div>
                <div class="customContainer divHomeRecContainer">
                	<div class="customHeader divHomeRecHeader" id="divHomeHeaderStep3" align="left">
                    	<img src="images/HRLEFT3.jpg" alt="" width="208" height="72" />
                        <a href="#" onmouseout="changeImage('imgProtect','images/HR3out.jpg')" onmouseover="changeImage('imgProtect','images/HR3over.jpg')">
                        	<img src="images/HR3out.jpg" alt="Step 3: Protect Your Family" width="587" height="72" id="imgProtect" />
                        </a>
                    </div>
                	<div class="customContent divHomeRecContent lblEnterColor">
                        <label>&gt; Essential Medical Supplies
                        <br /><br />
                        &gt; Food &amp; Water
                        <br /><br />
                        &gt; Matches, Candles Other
                        <br /><br />
                        &gt; First-Aid Kits
                        <br /><br />
                        &gt; Other Important Survival Supplies</label>
                    </div>
                    <div class="customNavigation divHomeRecNavigation">
                    	<label><span class="lblEnterColor lblFontBold">A Family Emergency Survival Kit</span> provides your family with a kit In case of a major event you will need some basic supplies set aside. That way you will always be prepared to be self-sufficient for at least 72 hours while emergency workers focus on people in urgent need.
                        <br /><br />
                        <span class="lblEnterColor lblFontBold">First of All</span>, many of the items required in an emergency kit are found in most people’s homes. It’s just a question of taking some time and putting them together as your emergency kit. We have taken the time to pre-assemble some plans that are made available to you at a great price through some of our partnerships with other companies trying to help families prepare themselves.
                        <br /><br />
                        <span class="lblEnterColor lblFontBold">Secondly</span>, it will provide your family with a basic emergency response plans that will give you the peace of mind to know that in the event of a disaster, all of your family members will know what to do.</label>
                    </div>
                    <div class="customFooter divHomeRecFooter">
                    	<a href="http://homerecovery.ca/Pages/survivalkits.html" target="_blank" class="aUnderline lblFontBold">Find Our More > ></a>
                    </div>
                </div>
                <!-- InstanceEndEditable -->
            </div>
