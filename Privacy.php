...
<title>Privacy Policy - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- InstanceEndEditable -->
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
              ...
              <h1><!-- InstanceBeginEditable name="h1Title" -->Privacy Policy<!-- InstanceEndEditable --></h1>
          	</div><!-- end of Header -->
            <div class="customContent" id="divBasicContent">
                <!-- InstanceBeginEditable name="BasicContent" -->
                <div align="left">
                    <div class="divPageTitle" align="left">
                        <label class="lblPageTitle">Privacy Policy</label>
                    </div>
                        <label class="lblFontBold">P</label><label class="lblFontSize10 lblFontBold">rivacy:
                        <br /><br />
                        Continuity Inc. respects the privacy of any personal information provided by you and protects it through its Privacy Policy. Continuity Inc. reserves the right to disclose any information provided by you as it deems necessary to satisfy any applicable law, regulation, legal process, government request, to protect the Services or the rights of Continuity Inc., or as otherwise required or permitted by law. Continuity Inc. may use information provided by you in order to identify or resolve technical problems concerning the Services, to tailor its Services to you, to facilitate your use of the Services and to communicate with you.You agree to indemnify and hold harmless Continuity Inc., its affiliates, agents, licensors or their respective directors, officers, agents or employees against any and all damages, liabilities, losses, costs and expenses (including without limitation reasonable attorneys fees) in connection with any claim or action that arises from your breach of any of this Agreement or any misuse of the Services or your Account. Continuity Inc. reserves the right, at its own expense, to assume the exclusive defense and control of any matter otherwise subject to indemnification by you, but doing so will not excuse your indemnity obligations.
                         <br /><br />
                        Security:<br />
                        Our trained professionals are put through a security screening process. Each professional will have a police background check performed before any contact or service is performs by a representative from Continunity Inc. Our On-Line programs will be protected by a certified SSL provider which specialize in restricting outside persons from access your information. We will use all commercially reasonable efforts to restrict access to the data you store in your account to persons accessing such data through use of your account or password, including authorized Viewers. Continuity Inc. reserves the right to access your account for support requirements, and to verify that your account is not being misused. Continuity Inc. will not be liable for any loss or liability that you may incur as a result of anyone else using your password to access your account data, either with or without your knowledge or permission. You will not use anyone else's account at any time without the permission of the account holder. You will not attempt to gain unauthorized access to any servers or software controlled by Continuity Inc., or access such servers or software for unauthorized purposes. As part of the Services, Continuity Inc. will allow third parties that you select ("Authorized Viewers") to access certain inventory data records that you designate (the "Designated Records") in your account. You are solely responsible for selecting the Authorized Viewers and the Designated Records, and for the contents of the Designated Records. You acknowledge that Continuity Inc. does not and can not verify the accuracy of inventory data in your Account, and that you and not Continuity Inc. are responsible and liable for any damages, losses, liabilities, costs and expenses that may arise from the disclosure of the Designated Records to Authorized Viewers.</label>
                </div>
                <!-- InstanceEndEditable -->
            </div>
