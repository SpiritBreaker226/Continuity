...
<title>My Continuity Plans - Information Technology Recovery Team - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- InstanceEndEditable -->
...
{?>
	...
	mysql_select_db($database_conContinuty, $conContinuty); ?>
	<!-- InstanceBeginEditable name="CPUpdate" --><?php	 mysql_query("UPDATE ".$row_rsPlans['TableName']." SET ITR_EMP01 ='".str_replace("'","''",$_POST['ITR_EMP01'])."', ITR_EMP02 ='".str_replace("'","''",$_POST['ITR_EMP02'])."', ITR_EMP03 ='".str_replace("'","''",$_POST['ITR_EMP03'])."', ITR_EMP04 ='".str_replace("'","''",$_POST['ITR_EMP04'])."',ITR_EMP05 ='".str_replace("'","''",$_POST['ITR_EMP05'])."', ITR_EMP06 ='".str_replace("'","''",$_POST['ITR_EMP06'])."',ITR_EMP07 ='".str_replace("'","''",$_POST['ITR_EMP07'])."', ITR_EMP08 ='".str_replace("'","''",$_POST['ITR_EMP08'])."' WHERE UserID = ".$UserID, $conContinuty) or die(mysql_error()); ?><!-- InstanceEndEditable -->		    <?php 
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
              ...
              <h1><!-- InstanceBeginEditable name="h1Title" -->My Continuity Plans - <?php echo $strEdition; ?> Edition - Information Technology Recovery Team<!-- InstanceEndEditable --></h1>
          	</div><!-- end of Header -->
                ...
                <div class="customContent" id="divFloatingMenuContent">
                	<div align="left">
                            ...
                            <div class="divQuestionForms">
                                ...
                                <label>Employee Name:</label> <input type="text" name="ITR_EMP01" value="<?php echo $row_rsForm['ITR_EMP01']; ?>" size="20" maxlength="100" /><br />
                                <label>Phone:</label> <input type="text" name="ITR_EMP02" value="<?php echo $row_rsForm['ITR_EMP02']; ?>" size="20" maxlength="100" /><br />
                                <label>Cell:</label> <input type="text" name="ITR_EMP03" value="<?php echo $row_rsForm['ITR_EMP03']; ?>" size="20" maxlength="100" /><br />
                                <label>E-Mail:</label> <input type="text" name="ITR_EMP04" value="<?php echo $row_rsForm['ITR_EMP04']; ?>" size="20" maxlength="100" />
                                <br /><br />
                                <label>If unavailable:</label>
                                <br /><br />
                                <label class="lblSubQuestion">Back-Up Information Technology Team Coordinator:</label><br />
                                <label>Employee Name:</label> <input type="text" name="ITR_EMP05" value="<?php echo $row_rsForm['ITR_EMP05']; ?>" size="20" maxlength="100" /><br />
                                <label>Phone:</label> <input type="text" name="ITR_EMP06" value="<?php echo $row_rsForm['ITR_EMP06']; ?>" size="20" maxlength="100" /><br />
                                <label>Cell:</label> <input type="text" name="ITR_EMP07" value="<?php echo $row_rsForm['ITR_EMP07']; ?>" size="20" maxlength="100" /><br />
                                <label>E-Mail:</label> <input type="text" name="ITR_EMP08" value="<?php echo $row_rsForm['ITR_EMP08']; ?>" size="20" maxlength="100" />
                            </div>
                			<!-- InstanceEndEditable -->
                	</div>
                </div>
