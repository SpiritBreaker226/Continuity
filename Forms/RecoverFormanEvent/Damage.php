...
<title>My Continuity Plans - Damage Assessment Team - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- InstanceEndEditable -->
...
{?>
	...
	mysql_select_db($database_conContinuty, $conContinuty); ?>
	<!-- InstanceBeginEditable name="CPUpdate" --><?php mysql_query("UPDATE ".$row_rsPlans['TableName']." SET DAT_EMP01 ='".str_replace("'","''",$_POST['DAT_EMP01'])."',DAT_EMP02 ='".str_replace("'","''",$_POST['DAT_EMP02'])."',DAT_EMP03 ='".str_replace("'","''",$_POST['DAT_EMP03'])."',DAT_EMP04 ='".str_replace("'","''",$_POST['DAT_EMP04'])."',DAT_EMP05 ='".str_replace("'","''",$_POST['DAT_EMP05'])."',DAT_EMP06 ='".str_replace("'","''",$_POST['DAT_EMP06'])."',DAT_EMP07 ='".str_replace("'","''",$_POST['DAT_EMP07'])."',DAT_EMP08 ='".str_replace("'","''",$_POST['DAT_EMP08'])."' WHERE UserID = ".$UserID, $conContinuty) or die(mysql_error()); ?><!-- InstanceEndEditable -->		    <?php 
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
              ...
              <h1><!-- InstanceBeginEditable name="h1Title" -->My Continuity Plans - <?php echo $strEdition; ?> Edition - Damage Assessment Team<!-- InstanceEndEditable --></h1>
          	</div><!-- end of Header -->
                ...
                <div class="customContent" id="divFloatingMenuContent">
                	<div align="left">
							...
							<div class="divQuestionForms">
								...
								<label>Employee Name:</label> <input type="text" name="DAT_EMP01" value="<?php echo $row_rsForm['DAT_EMP01']; ?>" size="20" maxlength="100" /><br />
								<label>Phone:</label> <input type="text" name="DAT_EMP02" value="<?php echo $row_rsForm['DAT_EMP02']; ?>" size="20" maxlength="100" /><br />
								<label>Cell:</label> <input type="text" name="DAT_EMP03" value="<?php echo $row_rsForm['DAT_EMP03']; ?>" size="20" maxlength="100" /><br />
								<label>E-Mail:</label> <input type="text" name="DAT_EMP04" value="<?php echo $row_rsForm['DAT_EMP04']; ?>" size="20" maxlength="100" />
                                <br /><br />
								<label>If unavailable:</label>
                                <br /><br />
								<label class="lblSubQuestion">Back-Up Damage Assessment Team Coordinator:</label><br />
								<label>Employee Name:</label> <input type="text" name="DAT_EMP05" value="<?php echo $row_rsForm['DAT_EMP05']; ?>" size="20" maxlength="100" /><br />
								<label>Phone:</label> <input type="text" name="DAT_EMP06" value="<?php echo $row_rsForm['DAT_EMP06']; ?>" size="20" maxlength="100" /><br />
								<label>Cell:</label> <input type="text" name="DAT_EMP07" value="<?php echo $row_rsForm['DAT_EMP07']; ?>" size="20" maxlength="100" /><br />
								<label>E-Mail:</label> <input type="text" name="DAT_EMP08" value="<?php echo $row_rsForm['DAT_EMP08']; ?>" size="20" maxlength="100" />
                            </div>
