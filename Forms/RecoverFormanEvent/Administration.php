...
<title>My Continuity Plans - Administration Recovery Team - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- InstanceEndEditable -->
...
{?>
	...
	mysql_select_db($database_conContinuty, $conContinuty); ?>
	<!-- InstanceBeginEditable name="CPUpdate" --><?php mysql_query("UPDATE ".$row_rsPlans['TableName']." SET ADMIN_EMP01 ='".str_replace("'","''",$_POST['ADMIN_EMP01'])."',ADMIN_EMP02 ='".str_replace("'","''",$_POST['ADMIN_EMP02'])."',ADMIN_EMP03 ='".str_replace("'","''",$_POST['ADMIN_EMP03'])."',ADMIN_EMP04 ='".str_replace("'","''",$_POST['ADMIN_EMP04'])."',ADMIN_EMP05 ='".str_replace("'","''",$_POST['ADMIN_EMP05'])."',ADMIN_EMP06 ='".str_replace("'","''",$_POST['ADMIN_EMP06'])."',ADMIN_EMP07 ='".str_replace("'","''",$_POST['ADMIN_EMP07'])."',ADMIN_EMP08 ='".str_replace("'","''",$_POST['ADMIN_EMP08'])."',ADMIN_PAY01 ='".str_replace("'","''",$_POST['ADMIN_PAY01'])."',ADMIN_PAY02 ='".str_replace("'","''",$_POST['ADMIN_PAY02'])."',ADMIN_PAY03 ='".str_replace("'","''",$_POST['ADMIN_PAY03'])."',ADMIN_PAY04 ='".str_replace("'","''",$_POST['ADMIN_PAY04'])."',ADMIN_PAY05 ='".str_replace("'","''",$_POST['ADMIN_PAY05'])."',ADMIN_PAY06 ='".str_replace("'","''",$_POST['ADMIN_PAY06'])."',ADMIN_PAY07 ='".str_replace("'","''",$_POST['ADMIN_PAY07'])."',ADMIN_PAY08 ='".str_replace("'","''",$_POST['ADMIN_PAY08'])."',ADMIN_PAY09 ='".str_replace("'","''",$_POST['ADMIN_PAY09'])."',ADMIN_PAY10 ='".str_replace("'","''",$_POST['ADMIN_PAY10'])."' WHERE UserID = ".$UserID,$conContinuty) or die(mysql_error()); ?><!-- InstanceEndEditable -->		    <?php 
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
              ...
              <h1><!-- InstanceBeginEditable name="h1Title" -->My Continuity Plans - <?php echo $strEdition; ?> Edition - Administration Recovery Team<!-- InstanceEndEditable --></h1>
          	</div><!-- end of Header -->
                ...
                <div class="customContent" id="divFloatingMenuContent">
                	<div align="left">
                            ...
                            <div class="divQuestionForms">
								...
								<label>Employee Name:</label> <input type="text" name="ADMIN_EMP01" value="<?php echo $row_rsForm['ADMIN_EMP01']; ?>" size="20" maxlength="100" /><br />
								<label>Phone:</label> <input type="text" name="ADMIN_EMP02" value="<?php echo $row_rsForm['ADMIN_EMP02']; ?>" size="14" maxlength="14" /><br />
								<label>Cell:</label> <input type="text" name="ADMIN_EMP03" value="<?php echo $row_rsForm['ADMIN_EMP03']; ?>" size="14" maxlength="14" /><br />
								<label>E-Mail:</label> <input type="text" name="ADMIN_EMP04" value="<?php echo $row_rsForm['ADMIN_EMP04']; ?>" size="20" maxlength="100" />
                                <br /><br />
								<label>If unavailable:</label>
                                <br /><br />
								<label class="lblSubQuestion">Back-Up Administration Recovery Team Coordinator:</label><br />
								<label>Employee Name:</label> <input type="text" name="ADMIN_EMP05" value="<?php echo $row_rsForm['ADMIN_EMP05']; ?>" size="20" maxlength="100" /><br />
								<label>Phone:</label> <input type="text" name="ADMIN_EMP06" value="<?php echo $row_rsForm['ADMIN_EMP06']; ?>" size="14" maxlength="14" /><br />
								<label>Cell:</label> <input type="text" name="ADMIN_EMP07" value="<?php echo $row_rsForm['ADMIN_EMP07']; ?>" size="14" maxlength="14" /><br />
								<label>E-Mail:</label> <input type="text" name="ADMIN_EMP08" value="<?php echo $row_rsForm['ADMIN_EMP08']; ?>" size="20" maxlength="100" />
							</div>
                            <div class="divQuestionForms">
								...
								<label>Employee Name:</label> <input type="text" name="ADMIN_PAY01" value="<?php echo $row_rsForm['ADMIN_PAY01']; ?>" size="20" maxlength="100" /><br />
								<label>Title:</label> <input type="text" name="ADMIN_PAY02" value="<?php echo $row_rsForm['ADMIN_PAY02']; ?>" size="20" maxlength="100" /><br />
								<label>Phone:</label> <input type="text" name="ADMIN_PAY03" value="<?php echo $row_rsForm['ADMIN_PAY03']; ?>" size="14" maxlength="14" /><br />
								<label>Cell:</label> <input type="text" name="ADMIN_PAY04" value="<?php echo $row_rsForm['ADMIN_PAY04']; ?>" size="14" maxlength="14" /><br />
								<label>E-Mail:</label> <input type="text" name="ADMIN_PAY05" value="<?php echo $row_rsForm['ADMIN_PAY05']; ?>" size="20" maxlength="100" />
                                <br /><br />
								<label>If unavailable:</label>
                                <br /><br />
								<label class="lblSubQuestion">(Back-Up) Payroll Employee:</label><br />
								<label>Employee Name:</label> <input type="text" name="ADMIN_PAY06" value="<?php echo $row_rsForm['ADMIN_PAY06']; ?>" size="20" maxlength="100" /><br />
								<label>Title:</label> <input type="text" name="ADMIN_PAY07" value="<?php echo $row_rsForm['ADMIN_PAY07']; ?>" size="20" maxlength="100" /><br />
								<label>Phone:</label> <input type="text" name="ADMIN_PAY08" value="<?php echo $row_rsForm['ADMIN_PAY08']; ?>" size="14" maxlength="14" /><br />
								<label>Cell:</label> <input type="text" name="ADMIN_PAY09" value="<?php echo $row_rsForm['ADMIN_PAY09']; ?>" size="14" maxlength="14" /><br />
								<label>E-Mail:</label> <input type="text" name="ADMIN_PAY10" value="<?php echo $row_rsForm['ADMIN_PAY10']; ?>" size="20" maxlength="100" />
							</div>                            
                			<!-- InstanceEndEditable -->
                	</div>
                </div>
