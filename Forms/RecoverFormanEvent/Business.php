...
<title>My Continuity Plans - Business Recovery Support Team - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- InstanceEndEditable -->
...
{?>
	...
	mysql_select_db($database_conContinuty, $conContinuty); ?>
	<!-- InstanceBeginEditable name="CPUpdate" --><?php mysql_query("UPDATE ".$row_rsPlans['TableName']." SET BST_EMP01 ='".str_replace("'","''",$_POST['BST_EMP01'])."',BST_EMP02 ='".str_replace("'","''",$_POST['BST_EMP02'])."',BST_EMP03 ='".str_replace("'","''",$_POST['BST_EMP03'])."',BST_EMP04 ='".str_replace("'","''",$_POST['BST_EMP04'])."',BST_EMP05 ='".str_replace("'","''",$_POST['BST_EMP05'])."',BST_EMP06 ='".str_replace("'","''",$_POST['BST_EMP06'])."',BST_EMP07 ='".str_replace("'","''",$_POST['BST_EMP07'])."',BST_EMP08 ='".str_replace("'","''",$_POST['BST_EMP08'])."' WHERE UserID = ".$UserID, $conContinuty) or die(mysql_error()); ?><!-- InstanceEndEditable -->		    <?php 
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
              ...
              <h1><!-- InstanceBeginEditable name="h1Title" -->My Continuity Plans - <?php echo $strEdition; ?> Edition - Business Recovery Support Team<!-- InstanceEndEditable --></h1>
          	</div><!-- end of Header -->
                ...
                <div class="customContent" id="divFloatingMenuContent">
                	<div align="left">
                            ...
                            <div class="divQuestionForms">
                                ...
                                <label>Employee Name:</label> <input type="text" name="BST_EMP01" value="<?php echo $row_rsForm['BST_EMP01']; ?>" size="20" maxlength="100" /><br />
                                <label>Phone:</label> <input type="text" name="BST_EMP02" value="<?php echo $row_rsForm['BST_EMP02']; ?>" size="20" maxlength="100" /><br />
                                <label>Cell:</label> <input type="text" name="BST_EMP03" value="<?php echo $row_rsForm['BST_EMP03']; ?>" size="20" maxlength="100" /><br />
                                <label>E-Mail:</label> <input type="text" name="BST_EMP04" value="<?php echo $row_rsForm['BST_EMP04']; ?>" size="20" maxlength="100" />
                                <br /><br />
                                <label>If unavailable:</label>
                                <br /><br />
								<label class="lblSubQuestion">Back-Up Business Support Team Coordinator:</label><br />
                                <label>Employee Name:</label> <input type="text" name="BST_EMP05" value="<?php echo $row_rsForm['BST_EMP05']; ?>" size="20" maxlength="100" /><br />
                                <label>Phone:</label> <input type="text" name="BST_EMP06" value="<?php echo $row_rsForm['BST_EMP06']; ?>" size="20" maxlength="100" /><br />
                                <label>Cell:</label> <input type="text" name="BST_EMP07" value="<?php echo $row_rsForm['BST_EMP07']; ?>" size="20" maxlength="100" /><br />
                                <label>E-Mail:</label> <input type="text" name="BST_EMP08" value="<?php echo $row_rsForm['BST_EMP08']; ?>" size="20" maxlength="100" />
							</div>
                			<!-- InstanceEndEditable -->
                	</div>
                </div>
