...
<title>Thank You For Your Submission - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- InstanceEndEditable -->
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
              ...
              <h1><!-- InstanceBeginEditable name="h1Title" -->Thank You For Your Submission<!-- InstanceEndEditable --></h1>
          	</div><!-- end of Header -->
            <div class="customContent" id="divBasicContent">
                <!-- InstanceBeginEditable name="BasicContent" -->
                <br /><br />
				<div id="divThankYou">
                	<label class="lblThankYou">Thank You.<br />One of our agents will be contacting you shortly.</label>
                    <br /><br />
                ...
                <div align="left">
                	<?php 
						...
						$rsPlans = mysql_query("SELECT * FROM continuityplans WHERE sectionName = 'ThankYou'", $conContinuty) or die("Plans: ".mysql_error());
						$row_rsPlans = mysql_fetch_assoc($rsPlans);

						//gest the uses data from the database						
						mysql_select_db($database_conContinuty, $conContinuty);
						$LoginRS = mysql_query("SELECT * FROM users WHERE users.id=".getUserID(), $conContinuty) or die("User: ".mysql_error());
						$row_loginFoundUser = mysql_fetch_assoc($LoginRS);

						$arrPrev = split("#",$row_rsPlans['prevSection']);//holds the array of section may go depending of the solution they are using
						$strPrevForm = $strPrevForm = $arrPrev[0];//holds the file name of the next section
						...
						if($strPrevForm <> "")
						{
							...
							echo "<a href=\"../".str_replace(" ","",$row_rsPrevPlans['mainSectionName'])."/".$strPrevForm.".php?SubFolder=2&Section=".$row_rsPrevPlans['id']."\">
