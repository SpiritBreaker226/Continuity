...
<title>My Continuity Plans - Environment &amp; Privacy - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- InstanceEndEditable -->
...
{?>
	...
	mysql_select_db($database_conContinuty, $conContinuty); ?>
	<!-- InstanceBeginEditable name="CPUpdate" --><?php mysql_query("UPDATE ".$row_rsPlans['TableName']." SET ENV_CPN01='".str_replace("'","''",$_POST['ENV_CPN01'])."',ENV_CPN02='".str_replace("'","''",$_POST['ENV_CPN02'])."',ENV_CPN03='".str_replace("'","''",$_POST['ENV_CPN03'])."',ENV_CPNus01='".str_replace("'","''",$_POST['ENV_CPNus01'])."',ENV_CPNus02='".str_replace("'","''",$_POST['ENV_CPNus02'])."',ENV_CPNus03='".str_replace("'","''",$_POST['ENV_CPNus03'])."',ENV_CPN04='".str_replace("'","''",$_POST['ENV_CPN04'])."',ENV_CPN05='".str_replace("'","''",$_POST['ENV_CPN05'])."',ENV_CPN06='".str_replace("'","''",$_POST['ENV_CPN06'])."',ENV_CPN07='".str_replace("'","''",$_POST['ENV_CPN07'])."',ENV_CPN08='".str_replace("'","''",$_POST['ENV_CPN08'])."',ENV_CPN09='".str_replace("'","''",$_POST['ENV_CPN09'])."',ENV_CPN10='".str_replace("'","''",$_POST['ENV_CPN10'])."',ENV_CPN11='".str_replace("'","''",$_POST['ENV_CPN11'])."',ENV_CPN12='".str_replace("'","''",$_POST['ENV_CPN12'])."' WHERE UserID = ".$UserID, $conContinuty) or die(mysql_error()); ?><!-- InstanceEndEditable -->		    <?php 
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
              ...
              <h1><!-- InstanceBeginEditable name="h1Title" -->My Continuity Plans - <?php echo $strEdition; ?> Edition - Environment &amp; Privacy<!-- InstanceEndEditable --></h1>
          	</div><!-- end of Header -->
                ...
                <div class="customContent" id="divFloatingMenuContent">
                	<div align="left">
                            ...
                            <div class="divQuestionForms">
                                ...
                                <label>Phone:</label> <input type="text" name="ENV_CPN01" value="<?php echo $row_rsForm['ENV_CPN01']; ?>" size="20" maxlength="100" /><br />
                                <label>Alt. Phone:</label> <input type="text" name="ENV_CPN02" value="<?php echo $row_rsForm['ENV_CPN02']; ?>" size="20" maxlength="100" /><br />
                                <label>Contact:</label> <input type="text" name="ENV_CPN03" value="<?php echo $row_rsForm['ENV_CPN03']; ?>" size="20" maxlength="100" /><br /><br />
                                <label class="lblSubQuestion">Environmental State Police (US):</label><br />
                                <label>Phone:</label> <input type="text" name="ENV_CPNus01" value="<?php echo $row_rsForm['ENV_CPNus01']; ?>" size="20" maxlength="100" /><br />
                                <label>Alt. Phone:</label> <input type="text" name="ENV_CPNus02" value="<?php echo $row_rsForm['ENV_CPNus02']; ?>" size="20" maxlength="100" /><br />
                                <label>Contact:</label> <input type="text" name="ENV_CPNus03" value="<?php echo $row_rsForm['ENV_CPNus03']; ?>" size="20" maxlength="100" /><br /><br />
                                <label class="lblSubQuestion">Environmental Municipal Police:</label><br />
                                <label>Phone:</label> <input type="text" name="ENV_CPN04" value="<?php echo $row_rsForm['ENV_CPN04']; ?>" size="20" maxlength="100" /><br />
                                <label>Alt. Phone:</label> <input type="text" name="ENV_CPN05" value="<?php echo $row_rsForm['ENV_CPN05']; ?>" size="20" maxlength="100" /><br />
                                <label>Contact:</label> <input type="text" name="ENV_CPN06" value="<?php echo $row_rsForm['ENV_CPN06']; ?>" size="20" maxlength="100" /><br /><br />
                                <label class="lblSubQuestion">Fire Department Spill Response Team:</label><br />
                                <label>Phone:</label> <input type="text" name="ENV_CPN07" value="<?php echo $row_rsForm['ENV_CPN07']; ?>" size="20" maxlength="100" /><br />
                                <label>Alt. Phone:</label> <input type="text" name="ENV_CPN08" value="<?php echo $row_rsForm['ENV_CPN08']; ?>" size="20" maxlength="100" /><br />
                                <label>Contact:</label> <input type="text" name="ENV_CPN09" value="<?php echo $row_rsForm['ENV_CPN09']; ?>" size="20" maxlength="100" /><br /><br />
                                <label class="lblSubQuestion">Electronics Recycling Depot:</label><br />
                                <label>Phone:</label> <input type="text" name="ENV_CPN10" value="<?php echo $row_rsForm['ENV_CPN10']; ?>" size="20" maxlength="100" /><br />
                                <label>Alt. Phone:</label> <input type="text" name="ENV_CPN11" value="<?php echo $row_rsForm['ENV_CPN11']; ?>" size="20" maxlength="100" /><br />
                                <label>Contact:</label> <input type="text" name="ENV_CPN12" value="<?php echo $row_rsForm['ENV_CPN12']; ?>" size="20" maxlength="100" />
							</div>
                			<!-- InstanceEndEditable -->
                	</div>
                </div>
