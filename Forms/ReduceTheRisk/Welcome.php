...
<title>Welcome Page - My Continuity Plan Start-Up Wizard - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- InstanceEndEditable -->
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
              ...
              <h1><!-- InstanceBeginEditable name="h1Title" -->Welcome Page - My Continuity Plan Start-Up Wizard<!-- InstanceEndEditable --></h1>
          	</div><!-- end of Header -->
            <div class="customContent" id="divBasicContent">
                <!-- InstanceBeginEditable name="BasicContent" -->
                <div align="left" class="divPageSubTitle">
                	<label>Welcome to My Continuity Plan Start-Up Wizard. This program will help us obtain the essential information needed to put a plan in place to protect you and your business. These series of questions will be interpreted and developed into proactive Continuity Plans for your business.
<br /><br />
Please complete each section as accurately as possible. If you do not understand or have any questions please contact one of our trained professionals for assistance and guidance.
<br /><br />
At any point in the you wish to pause or save your progress, make sure you click the save button so the wizard will remember where you stopped.
<br /><br />
To start building your plan click the button below. Thank you for choosing Continuity Inc.</label>
                </div>
                <div class="customContainer" id="divWelcomeContainer">
    	            <div class="customContent" id="divWelcomeContent" align="left">
    	            	<a href="../../Profile.php"><img alt="Back To Your Profile" src="../../images/buttonPrevious.jpg" /></a>
    	            </div>
    	            <div class="customNavigation" id="divWelcomeNavigation" align="right">
                    	<?php  
						//does a selection for the users data for the ThankYouForm
						mysql_select_db($database_conContinuty, $conContinuty); 
						$rsPlans = mysql_query("SELECT * FROM continuityplans WHERE sectionName = 'Welcome'", $conContinuty) or die("Plans: ".mysql_error());
    	            	...
    	            	echo "<a href=\"".$strNextForm.".php?SubFolder=2&amp;Section=1\"><img alt=\"Start Button\" src=\"../../images/buttonNext.jpg\" /></a>" ?>
    	            </div>
	                <div class="customFooter" id="divWelcomeNavigation"></div>
                </div>
                <!-- InstanceEndEditable -->
            </div>
