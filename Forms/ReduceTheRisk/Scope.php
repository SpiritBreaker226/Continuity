...
<title>My Continuity Plans - Project Introduction &amp; Scope - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- InstanceEndEditable -->
...
{?>
	...
	mysql_select_db($database_conContinuty, $conContinuty); ?>
	<!-- InstanceBeginEditable name="CPUpdate" --><?php mysql_query("UPDATE ".$row_rsPlans['TableName']." SET intro_01 ='".str_replace("'","''",$_POST['intro_01'])."', intro_02 ='".str_replace("'","''",$_POST['intro_02'])."', intro_03 ='".str_replace("'","''",$_POST['intro_03'])."', intro_04 ='".str_replace("'","''",$_POST['intro_04'])."',intro_05 ='".str_replace("'","''",$_POST['intro_05'])."', intro_06 ='".str_replace("'","''",$_POST['intro_06'])."', intro_07 ='".str_replace("'","''",$_POST['intro_07'])."', intro_08 ='".str_replace("'","''",$_POST['intro_08'])."' WHERE UserID = ".$UserID, $conContinuty) or die(mysql_error()); ?><!-- InstanceEndEditable -->		    <?php 
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
              ...
              <h1><!-- InstanceBeginEditable name="h1Title" -->My Continuity Plans - <?php echo $strEdition; ?> Edition - Project Introduction &amp; Scope<!-- InstanceEndEditable --></h1>
          	</div><!-- end of Header -->
              ...
              <div class="customContainer" id="divFloatingMenuContainer">
                <div class="customContent" id="divFloatingMenuContent">
                	<div align="left">
                            ...
                            <br />
                            <div class="divPageSubTitle">
	                            <label>SECTION 1: Project Scope & Objectives</label>
							</div>-->
                            <div class="divQuestionForms">
								...
								<br />
                                Business Name: </label><input type="text" name="intro_01" value="<?php echo $row_rsForm['intro_01']; ?>" size="20" maxlength="100" />
							</div>
                            <div class="divQuestionForms">
								...
								<br /><br />
								Street Name Address: </label><input type="text" name="intro_02" value="<?php echo $row_rsForm['intro_02']; ?>" size="20" maxlength="100" /><label>
                                <br />
								City: </label><input type="text" name="intro_03" value="<?php echo $row_rsForm['intro_03']; ?>" size="20" maxlength="100" /><label>
                                Province: </label><input type="text" name="intro_04" value="<?php echo $row_rsForm['intro_04']; ?>" size="20" maxlength="100" /><label>
                                Postal/ZIP Code: </label><input type="text" name="intro_05" value="<?php echo $row_rsForm['intro_05']; ?>" size="20" maxlength="100" /><label>
                                <br />
								Country: </label><input type="text" name="intro_06" value="<?php echo $row_rsForm['intro_06']; ?>" size="20" maxlength="100" /><label></label>
							</div>
                            <div class="divQuestionForms">
                                ...
                                <label>Text:
                                <br /><br />
								Please give a brief overview of what your business is trying to accomplish in terms of a back-up plan. If an individual were to read this it would identify the reason for your business is developing a plan?</label>
								<br /><br />
								<textarea name="intro_07" cols="85" rows="30"><?php echo $row_rsForm['intro_07']; ?></textarea>
							</div>
                            <div class="divQuestionForms">
								...
								<label>Text:
                                <br /><br />
								Please identify some of the objectives you wish to reach by putting a Business Continuity Plan in place. ie. What do you expect from this plan?</label>
								<br /><br />
								<textarea name="intro_08" cols="85" rows="30"><?php echo $row_rsForm['intro_08']; ?></textarea>
							</div>
							<!-- InstanceEndEditable -->
                	</div>
                </div>
