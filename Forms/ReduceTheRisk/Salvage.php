...
<title>My Continuity Plans - Salvage &amp; Security - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- InstanceEndEditable -->
...
{?>
	...
	mysql_select_db($database_conContinuty, $conContinuty); ?>
	<!-- InstanceBeginEditable name="CPUpdate" --><?php mysql_query("UPDATE ".$row_rsPlans['TableName']." SET SAL_CPN01 ='".str_replace("'","''",$_POST['SAL_CPN01'])."',SAL_CPN02 ='".str_replace("'","''",$_POST['SAL_CPN02'])."',SAL_CPN03 ='".str_replace("'","''",$_POST['SAL_CPN03'])."',SAL_CPN04 ='".str_replace("'","''",$_POST['SAL_CPN04'])."',SAL_CPN05 ='".str_replace("'","''",$_POST['SAL_CPN05'])."',SAL_CPN06 ='".str_replace("'","''",$_POST['SAL_CPN06'])."',SAL_CPN07 ='".str_replace("'","''",$_POST['SAL_CPN07'])."',SAL_CPN08 ='".str_replace("'","''",$_POST['SAL_CPN08'])."',SAL_CPN09 ='".str_replace("'","''",$_POST['SAL_CPN09'])."',SAL_CPN10 ='".str_replace("'","''",$_POST['SAL_CPN10'])."',SAL_CPN11 ='".str_replace("'","''",$_POST['SAL_CPN11'])."',SAL_CPN12 ='".str_replace("'","''",$_POST['SAL_CPN12'])."',SAL_CPN13 ='".str_replace("'","''",$_POST['SAL_CPN13'])."',SAL_CPN14 ='".str_replace("'","''",$_POST['SAL_CPN14'])."',SAL_CPN15 ='".str_replace("'","''",$_POST['SAL_CPN15'])."',SAL_CPN16 ='".str_replace("'","''",$_POST['SAL_CPN16'])."',SAL_CPN17 ='".str_replace("'","''",$_POST['SAL_CPN17'])."',SAL_CPN18 ='".str_replace("'","''",$_POST['SAL_CPN18'])."',SAL_CPN19 ='".str_replace("'","''",$_POST['SAL_CPN19'])."',SAL_CPN20 ='".str_replace("'","''",$_POST['SAL_CPN20'])."',SAL_CPN21 ='".str_replace("'","''",$_POST['SAL_CPN21'])."',SAL_CPN22 ='".str_replace("'","''",$_POST['SAL_CPN22'])."',SAL_CPN23 ='".str_replace("'","''",$_POST['SAL_CPN23'])."',SAL_CPN24 ='".str_replace("'","''",$_POST['SAL_CPN24'])."',SAL_CPN25 ='".str_replace("'","''",$_POST['SAL_CPN25'])."',SAL_CPN26 ='".str_replace("'","''",$_POST['SAL_CPN26'])."',SAL_CPN27 ='".str_replace("'","''",$_POST['SAL_CPN27'])."',SAL_CPN28 ='".str_replace("'","''",$_POST['SAL_CPN28'])."',SAL_CPN29 ='".str_replace("'","''",$_POST['SAL_CPN29'])."',SAL_CPN30 ='".str_replace("'","''",$_POST['SAL_CPN30'])."',SAL_CPN31 ='".str_replace("'","''",$_POST['SAL_CPN31'])."',SAL_CPN32 ='".str_replace("'","''",$_POST['SAL_CPN32'])."',SAL_CPN33 ='".str_replace("'","''",$_POST['SAL_CPN33'])."',SAL_CPN34 ='".str_replace("'","''",$_POST['SAL_CPN34'])."',SAL_CPN35 ='".str_replace("'","''",$_POST['SAL_CPN35'])."',SAL_CPN36 ='".str_replace("'","''",$_POST['SAL_CPN36'])."',SAL_CPN37 ='".str_replace("'","''",$_POST['SAL_CPN37'])."',SAL_CPN38 ='".str_replace("'","''",$_POST['SAL_CPN38'])."',SAL_CPN39 ='".str_replace("'","''",$_POST['SAL_CPN39'])."',SAL_CPN40 ='".str_replace("'","''",$_POST['SAL_CPN40'])."',SAL_CPN41 ='".str_replace("'","''",$_POST['SAL_CPN41'])."',SAL_CPN42 ='".str_replace("'","''",$_POST['SAL_CPN42'])."',SAL_CPN43 ='".str_replace("'","''",$_POST['SAL_CPN43'])."',SAL_CPN44 ='".str_replace("'","''",$_POST['SAL_CPN44'])."',SAL_CPN45 ='".str_replace("'","''",$_POST['SAL_CPN45'])."',SAL_CPN46 ='".str_replace("'","''",$_POST['SAL_CPN46'])."',SAL_CPN47 ='".str_replace("'","''",$_POST['SAL_CPN47'])."',SAL_CPN48 ='".str_replace("'","''",$_POST['SAL_CPN48'])."' WHERE
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
              ...
              <h1><!-- InstanceBeginEditable name="h1Title" -->My Continuity Plans - <?php echo $strEdition; ?> Edition - Salvage &amp; Security<!-- InstanceEndEditable --></h1>
          	</div><!-- end of Header -->
                ...
                <div class="customContent" id="divFloatingMenuContent">
                	<div align="left">
                            ...
                            <div class="divQuestionForms">
								...
								<label>Company Name:</label> <input type="text" name="SAL_CPN01" value="<?php echo $row_rsForm['SAL_CPN01']; ?>" size="20" maxlength="100" /><br/>
								<label>Phone:</label> <input type="text" name="SAL_CPN02" value="<?php echo $row_rsForm['SAL_CPN02']; ?>" size="20" maxlength="100" /><br/>
								<label>Contact:</label> <input type="text" name="SAL_CPN03" value="<?php echo $row_rsForm['SAL_CPN03']; ?>" size="20" maxlength="100" /><br/>
                                <br /><br />
								<label class="lblSubQuestion">Freight &amp; Transportation 2:</label><br/>
								<label>Company Name:</label> <input type="text" name="SAL_CPN04" value="<?php echo $row_rsForm['SAL_CPN04']; ?>" size="20" maxlength="100" /><br/>
								<label>Phone:</label> <input type="text" name="SAL_CPN05" value="<?php echo $row_rsForm['SAL_CPN05']; ?>" size="20" maxlength="100" /><br/>
								<label>Contact:</label> <input type="text" name="SAL_CPN06" value="<?php echo $row_rsForm['SAL_CPN06']; ?>" size="20" maxlength="100" /><br/>
                                <br /><br />
								<label class="lblSubQuestion">Freight &amp; Transportation 3:</label><br/>
								<label>Company Name:</label> <input type="text" name="SAL_CPN07" value="<?php echo $row_rsForm['SAL_CPN07']; ?>" size="20" maxlength="100" /><br/>
								<label>Phone:</label> <input type="text" name="SAL_CPN08" value="<?php echo $row_rsForm['SAL_CPN08']; ?>" size="20" maxlength="100" /><br/>
								<label>Contact:</label> <input type="text" name="SAL_CPN09" value="<?php echo $row_rsForm['SAL_CPN09']; ?>" size="20" maxlength="100" /><br/>
                                <br /><br />
								<label class="lblSubQuestion">Off-Site Storage 2:</label><br/>
								<label>Company Name:</label> <input type="text" name="SAL_CPN10" value="<?php echo $row_rsForm['SAL_CPN10']; ?>" size="20" maxlength="100" /><br/>
								<label>Phone:</label> <input type="text" name="SAL_CPN11" value="<?php echo $row_rsForm['SAL_CPN11']; ?>" size="20" maxlength="100" /><br/>
								<label>Contact:</label> <input type="text" name="SAL_CPN12" value="<?php echo $row_rsForm['SAL_CPN12']; ?>" size="20" maxlength="100" /><br/>
                                <br /><br />
								<label class="lblSubQuestion">Off-Site Storage 3:</label><br/>
								<label>Company Name:</label> <input type="text" name="SAL_CPN13" value="<?php echo $row_rsForm['SAL_CPN13']; ?>" size="20" maxlength="100" /><br/>
								<label>Phone:</label> <input type="text" name="SAL_CPN14" value="<?php echo $row_rsForm['SAL_CPN14']; ?>" size="20" maxlength="100" /><br/>
								<label>Contact:</label> <input type="text" name="SAL_CPN15" value="<?php echo $row_rsForm['SAL_CPN15']; ?>" size="20" maxlength="100" /><br/>
							</div>
                            <div class="divQuestionForms">
								...
								<label>Company Name:</label> <input type="text" name="SAL_CPN16" value="<?php echo $row_rsForm['SAL_CPN16']; ?>" size="20" maxlength="100" /><br/>
								<label>Phone:</label> <input type="text" name="SAL_CPN17" value="<?php echo $row_rsForm['SAL_CPN17']; ?>" size="20" maxlength="100" /><br/>
								<label>Contact:</label> <input type="text" name="SAL_CPN18" value="<?php echo $row_rsForm['SAL_CPN18']; ?>" size="20" maxlength="100" /><br/>
                                <br /><br />
								<label class="lblSubQuestion">Customs Broker 2:</label><br/>
								<label>Company Name:</label> <input type="text" name="SAL_CPN19" value="<?php echo $row_rsForm['SAL_CPN19']; ?>" size="20" maxlength="100" /><br/>
								<label>Phone:</label> <input type="text" name="SAL_CPN20" value="<?php echo $row_rsForm['SAL_CPN20']; ?>" size="20" maxlength="100" /><br/>
								<label>Contact:</label> <input type="text" name="SAL_CPN21" value="<?php echo $row_rsForm['SAL_CPN21']; ?>" size="20" maxlength="100" /><br/>
							</div>
                            <div class="divQuestionForms">
								...
								<label>Company Name:</label> <input type="text" name="SAL_CPN22" value="<?php echo $row_rsForm['SAL_CPN22']; ?>" size="20" maxlength="100" /><br/>
								<label>Phone:</label> <input type="text" name="SAL_CPN23" value="<?php echo $row_rsForm['SAL_CPN23']; ?>" size="20" maxlength="100" /><br/>
								<label>Contact:</label> <input type="text" name="SAL_CPN24" value="<?php echo $row_rsForm['SAL_CPN24']; ?>" size="20" maxlength="100" /><br/><br/>
								<label>Description of Services:</label><br />
                                <textarea name="SAL_CPN25" cols="85" rows="30"><?php echo $row_rsForm['SAL_CPN25']; ?></textarea>
                                <br /><br />
								<label class="lblSubQuestion">Security Company 2:</label><br/>
								<label>Company Name:</label> <input type="text" name="SAL_CPN26" value="<?php echo $row_rsForm['SAL_CPN26']; ?>" size="20" maxlength="100" /><br/>
								<label>Phone:</label> <input type="text" name="SAL_CPN27" value="<?php echo $row_rsForm['SAL_CPN27']; ?>" size="20" maxlength="100" /><br/>
								<label>Contact:</label> <input type="text" name="SAL_CPN28" value="<?php echo $row_rsForm['SAL_CPN28']; ?>" size="20" maxlength="100" /><br/><br/>
								<label>Description of Services:</label><br />
                                <textarea name="SAL_CPN29" cols="85" rows="30"><?php echo $row_rsForm['SAL_CPN29']; ?></textarea>
							</div>
                            <div class="divQuestionForms">
								...
								<label>Institution Name:</label> <input type="text" name="SAL_CPN30" value="<?php echo $row_rsForm['SAL_CPN30']; ?>" size="20" maxlength="100" /><br/>
								<label>Account #:</label> <input type="text" name="SAL_CPN31" value="<?php echo $row_rsForm['SAL_CPN31']; ?>" size="20" maxlength="100" /><br/>
								<label>Phone:</label> <input type="text" name="SAL_CPN32" value="<?php echo $row_rsForm['SAL_CPN32']; ?>" size="20" maxlength="100" /><br/>
								<label>Account Rep:</label> <input type="text" name="SAL_CPN33" value="<?php echo $row_rsForm['SAL_CPN33']; ?>" size="20" maxlength="100" /><br/>
                                <br /><br />
								<label class="lblSubQuestion">Bank &amp; Financial Information 2:</label><br/>
								<label>Institution Name:</label> <input type="text" name="SAL_CPN34" value="<?php echo $row_rsForm['SAL_CPN34']; ?>" size="20" maxlength="100" /><br/>
								<label>Account #:</label> <input type="text" name="SAL_CPN35" value="<?php echo $row_rsForm['SAL_CPN35']; ?>" size="20" maxlength="100" /><br/>
								<label>Phone:</label> <input type="text" name="SAL_CPN36" value="<?php echo $row_rsForm['SAL_CPN36']; ?>" size="20" maxlength="100" /><br/>
								<label>Account Rep:</label> <input type="text" name="SAL_CPN37" value="<?php echo $row_rsForm['SAL_CPN37']; ?>" size="20" maxlength="100" /><br/>
                                <br /><br />
								<label class="lblSubQuestion">Office Furniture Supplier 1:</label><br/>
								<label>Company Name:</label> <input type="text" name="SAL_CPN38" value="<?php echo $row_rsForm['SAL_CPN38']; ?>" size="20" maxlength="100" /><br/>
								<label>Account #:</label> <input type="text" name="SAL_CPN39" value="<?php echo $row_rsForm['SAL_CPN39']; ?>" size="20" maxlength="100" /><br/>
								<label>Phone:</label> <input type="text" name="SAL_CPN40" value="<?php echo $row_rsForm['SAL_CPN40']; ?>" size="20" maxlength="100" /><br/>
								<label>Account Rep:</label> <input type="text" name="SAL_CPN41" value="<?php echo $row_rsForm['SAL_CPN41']; ?>" size="20" maxlength="100" /><br/>
                                <br /><br />
								<label class="lblSubQuestion">Insurance Company 1:</label><br/>
								<label>Company Name:</label> <input type="text" name="SAL_CPN42" value="<?php echo $row_rsForm['SAL_CPN42']; ?>" size="20" maxlength="100" /><br/>
								<label>Policy #:</label> <input type="text" name="SAL_CPN43" value="<?php echo $row_rsForm['SAL_CPN43']; ?>" size="20" maxlength="100" /><br/>
								<label>Phone:</label> <input type="text" name="SAL_CPN44" value="<?php echo $row_rsForm['SAL_CPN44']; ?>" size="20" maxlength="100" /><br/>
								<label>Account Rep:</label> <input type="text" name="SAL_CPN45" value="<?php echo $row_rsForm['SAL_CPN45']; ?>" size="20" maxlength="100" /><br/>
                                <br /><br />
								<label class="lblSubQuestion">Off-Site IT Provider 1:</label><br/>
								<label>Company Name:</label> <input type="text" name="SAL_CPN46" value="<?php echo $row_rsForm['SAL_CPN46']; ?>" size="20" maxlength="100" /><br/>
								<label>Phone:</label> <input type="text" name="SAL_CPN47" value="<?php echo $row_rsForm['SAL_CPN47']; ?>" size="20" maxlength="100" /><br/>
								<label>Contact:</label> <input type="text" name="SAL_CPN48" value="<?php echo $row_rsForm['SAL_CPN48']; ?>" size="20" maxlength="100" /><br/>
							</div>
                			<!-- InstanceEndEditable -->
                	</div>
                </div>
