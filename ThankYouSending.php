...
<title>Thank You - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- InstanceEndEditable -->
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
              ...
              <h1><!-- InstanceBeginEditable name="h1Title" -->Thank You<!-- InstanceEndEditable --></h1>
          	</div><!-- end of Header -->
            <div class="customContent" id="divBasicContent">
				...
				<div id="divThankYou">
                    ...
                    <?php if($_GET['Modes'] == "1")
					{
						...
						if($_GET['id'] <> "")
						{
							if(strpos($_GET['id'],"--") === false || strpos($_GET['id'],"\\") === false || strpos($_GET['id'],"^") === false)
							{
								//updates the solution this user
								mysql_select_db($database_conContinuty, $conContinuty);
								$rsAssess = mysql_query("SELECT * FROM C2Assess WHERE id = '".$_GET['id']."'", $conContinuty) or die(mysql_error());
								$row_Assess = mysql_fetch_assoc($rsAssess);
							}//end of if
						}//end of if?>
                    	<div class="lblFontBold">
                            <label>Your Assessment Total: 
							<br />
							<?php echo $row_Assess['Q1'] + $row_Assess['Q2'] + $row_Assess['Q3'] + $row_Assess['Q4'] + $row_Assess['Q5'] + $row_Assess['Q6'] + $row_Assess['Q7'] + $row_Assess['Q8'] + $row_Assess['Q9'] + $row_Assess['Q10']; ?></label>
                        </div>
