...
<title>Services - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- InstanceEndEditable -->
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
              ...
              <h1><!-- InstanceBeginEditable name="h1Title" -->Services<!-- InstanceEndEditable --></h1>
          	</div><!-- end of Header -->
            <div class="customContent" id="divBasicContent">
                <!-- InstanceBeginEditable name="BasicContent" -->
                <div class="divPageTitle" align="left">
                	<label class="lblPageTitle">Services</label>
                </div>
                <div class="customContainer divServicesContainer">
                	<div class="customContent divServicesContent">
                    ...
                    <div class="customNavigation divServicesNavigation">
                    	<label><span class="lblReduceColor lblFontBold">Reducing the risk</span> will provide your busines with a better understanding on how a disaster could potentially impact your business. By assessing the risk, understand the impacts, and ensure you have accurate insurance coverage, you will be able to reduce the impact a disaster could have on your business.</label>
                    </div>
                    <div class="customFooter divServicesFooter"></div>
                </div>
                <div class="customContainer divServicesContainer">
                	<div class="customContent divServicesContent">
                ...
                <div class="customContainer divServicesContainer">
                    ...
                    <div class="customNavigation divServicesNavigation">
                    	<label><span class="lblRecoverColor lblFontBold">Recovering from a disaster</span> will provide your business with a step by step action plan to assess what damages have occurred, and what items were lost in the event. From this action plan you will be able to begin the recover and replacement process of all essential items that were lost. By having a recovery plan you will be able to recover the essential business functions that will allow you to remain in business.</label>
                    </div>
                    <div class="customFooter divServicesFooter"></div>
                </div>
                <div class="customContainer divServicesContainer">
