...
<title>RSA - Exclusive Offer - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- InstanceEndEditable -->
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
              ...
              <h1><!-- InstanceBeginEditable name="h1Title" -->RSA - Exclusive Offer<!-- InstanceEndEditable --></h1>
          	</div><!-- end of Header -->
            <div class="customContent" id="divBasicContent">
                ...
                <div align="left">
                         <div class="divRSASubTitle">
                          	<label class="lblRSASubTitle">Continuity Inc. Exclusive Offer for Royal &amp; SunAlliance Small Business Solutions&trade; Platnium Product&trade; Clients.</label>
                         </div>
                          	<label class="lblFontSize10">It may be impossible to predict a disaster, but it can benefit your business to prepare for it. Continuity Inc. Business Continuity &amp; Disaster Recovery has developed a program that will help your small business reduce the risk and give you a plan to help restore your business back to normal following a disaster. This exclusive offer is for Royal &amp; SunAlliance Small Business Solutions&trade; Platinum Product&trade; Clients.</label>
                    	<div class="divRSASubTitle">
                          <label class="lblRSASubTitle">What is Business Continuity Planning? </label>
                        </div>
                          <label class="lblFontSize10">Put simply, business continuity is about anticipating the crises that could affect your business and planning for them. Preparation increases the chance that your business will continue to function in the event of an emergency.
                          <br /><br />
                          Having an accurate insurance policy in place will help you protect your business, but it is only the first step. For many businesses, the real tragedy occurs after a disaster. They may have excellent business interruption insurance, but no recovery plan. Without it, down time can be considerable. Worse yet, three out of five businesses never fully recover from a disaster. </label>
						<div class="divRSASubTitle">
                          <label class="lblRSASubTitle">Why should my small business care about Business Continuity Planning? </label>
                        </div>
                          <label class="lblFontSize10">Business success is as much about protection as it is growth. In an uncertain world, that means creating a business strong enough to survive a disaster, and flexible enough to quickly re-open afterwards. This protection provides you with a great advantage.
                          <br /><br />      
                          There are also commercial benefits to consider, as companies with business continuity plans are more attractive to do business with. </label>
                    	<div class="divRSASubTitle">
                          <label class="lblRSASubTitle">Doesn’t it cost a lot of money to implement a Continuity Plan?</label>
                        </div>
                          <label class="lblFontSize10">It does not need to be a costly program. The business continuity plan will fit your business as it accounts for your key risks and out lines how your company manages them. Planning for the future will help protect the growth and success of your business.
                          <br /><br />
                          As a valued Royal &amp; SunAlliance Small Business Solutions&trade; Platinum Products&trade; client, this program is offered to you at an exclusive price. </label>
                    </div>
				<!-- InstanceEndEditable -->
