...
<title>RSA - Exclusive Pricing - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- InstanceEndEditable -->
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
              ...
              <h1><!-- InstanceBeginEditable name="h1Title" -->RSA - Exclusive Pricing<!-- InstanceEndEditable --></h1>
          	</div><!-- end of Header -->
            <div class="customContent" id="divBasicContent">
                ...
                <div align="left">
                	<div class="divRSASubTitle">
                       	<label class="lblRSASubTitle">Continuity Inc. Exclusive Pricing for Royal &amp; SunAlliance Small Business Solutions&trade; Platnium Product&trade; Clients</label>
                    </div>
            		<label class="lblFontSize10">As a customer of Royal &amp; SunAlliance Continuity Inc. is pleased to offer you access to our on-line plan development programs at an exclusive rate.
                    <br /><br />
                ...
                <div>
                	<a href="../Solutions.php?section=Solutions#Basic" onmouseout="changeImage('imgRSABasic','../images/RSAbasicprice.jpg')" onmouseover="changeImage('imgRSABasic','../images/RSAbasicover.jpg')"><img src="../images/RSAbasicprice.jpg" alt="Basic Offer" width="274" height="272" id="imgRSABasic" /></a>
                    <a href="../Solutions.php?section=Solutions#Standard" onmouseout="changeImage('imgRSAStandard','../images/RSASTDprice.jpg')" onmouseover="changeImage('imgRSAStandard','../images/RSAstandover.jpg')"><img src="../images/RSASTDprice.jpg" alt="Standard Offer" name="Standard Edition" width="274" height="272" border="0" id="imgRSAStandard" /></a>
                    <a href="../Solutions.php?section=Solutions#Enter" onmouseout="changeImage('imgRSAEnterprise','../images/RSAENTprice.jpg')" onmouseover="changeImage('imgRSAEnterprise','../images/RSAentover.jpg')"><img src="../images/RSAENTprice.jpg" alt="Enterprise Offer" name="Enterprise Edition" width="274" height="272" border="0" id="imgRSAEnterprise" /></a>                   
                </div>
				<!-- InstanceEndEditable -->
