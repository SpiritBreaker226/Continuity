...
<title>About Us - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- InstanceEndEditable -->
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
              ...
              <h1><!-- InstanceBeginEditable name="h1Title" -->About Us<!-- InstanceEndEditable --></h1>
          	</div><!-- end of Header -->
            <div class="customContent" id="divBasicContent">
                <!-- InstanceBeginEditable name="BasicContent" -->                      
                <div class="customContainer" id="divAboutUsTopContainer">
                	<div class="customContent" align="left" id="divAboutUsTopContent">
		                <img src="images/busIMG1.jpg" alt="" width="215" height="145" />
    		            <img src="images/busIMG2.jpg" alt="" width="215" height="145" />
        		        <img src="images/busIMG3.jpg" alt="" width="215" height="145" />
                    </div>
                    <div class="customNavigation" id="divAboutUsTopNavigation">
                    	<div id="divAboutUsQuto">
    	                    <label class="lblFontSize14">" The future of business lies in the hands of the prepared. "</label>
                        </div>
					    <div class="divPageTitle">
                        	<label>Continuity Inc.</label>
                        </div>
                    </div>
                    <div class="customFooter" id="divAboutUsTopFooter"></div>
                </div>
                <div class="divPageTitle" align="left">
                	<label class="lblPageTitle">About Us</label>
                </div>
                <div class="lblFontSize10" align="left">
                	<label>At <strong>Continuity inc</strong>, we believe that the future of business lies in the hands of the prepared. Any business, no matter what size, needs to have a back up plan in place.
                  	<br /><br />
                    There are more then 300 different disaster that can affect your business. Knowing which threats are most likely to happen, and preparing your company for them, can prevent you from experenceing a catastrophic loss. With a company background in Risk Management, Insurance &amp; Business Continuity, our professionals understand the importance of lowering your risks, responding to a disaster, and ensuring you can remain in business No Matter What!
			       	<br /><br />
      In determining how to best help business owners, we have harnesed one the greatest technologies by using the Internet. Using our <a href="Solutions.php?section=Solutions" title="Our On-Line Solutions" class="aUnderline">On-Line programs</a> we are able to create relationships with our customer and walk beside them as they start their road to recovery. Working with our <a href="Partners.php?section=Partners&Footer=1" title="Our Partners" class="aUnderline">Exclusive Partners</a> we are able to offer our clients more then just a product, we are able to offer them a continual relationship, based on the premis that every disaster or disruption to a business will bring on various requirements in terms of continuity and recovery.
      				<br /><br />
      Working with these partners we are able to connect our clients in the time of need to the approriate external resources in the industry. Don't wait for a disaster to stike your business, be pro-active with <strong>Continuity Inc.</strong> and start your journy on the road to being prepared.
                    </label>
                </div>
                <div class="divPageTitle">
                	<label class="lblPageTitle">Take the 4 simple steps listed below to prepared your business.</label>
                </div>
                <div align="left">
                    <a href="FourRs.php?section=Services&Footer=1&r=1" onmouseout="changeImage('imgReduce','images/Reduce2out.jpg')" onmouseover="changeImage('imgReduce','images/Reduce2over.jpg')"><img src="images/Reduce2out.jpg" alt="Reduce The Risk" id="imgReduce" /></a>
                    <a href="FourRs.php?section=Services&Footer=1&r=2" onmouseout="changeImage('imgRespond','images/Respond2out.jpg')" onmouseover="changeImage('imgRespond','images/Respond2over.jpg')"><img src="images/Respond2out.jpg" alt="Respond To A Disaster" id="imgRespond" /></a>
                    <a href="FourRs.php?section=Services&Footer=1&r=3" onmouseout="changeImage('imgRecover','images/Recover2out.jpg')" onmouseover="changeImage('imgRecover','images/Recover2over.jpg')"><img src="images/Recover2out.jpg" alt="Recover After A Loss" id="imgRecover" /></a>
                    <a href="FourRs.php?section=Services&Footer=1&r=4" onmouseout="changeImage('imgRestore','images/Restore2out.jpg')" onmouseover="changeImage('imgRestore','images/Restore2over.jpg')"><img src="images/Restore2out.jpg" alt="Restore Business As Usual" id="imgRestore" /></a>
                </div>
                <!-- InstanceEndEditable -->
            </div>
