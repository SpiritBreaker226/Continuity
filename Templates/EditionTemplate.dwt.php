...
<title>My Continuity Plans - ENTER SECTION NAME HERE - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- InstanceEndEditable -->
...
<!-- TemplateBeginEditable name="BackUpForSelect" -->
...
if($_POST['hfSubmit'] != '')
{?>
	<!-- TemplateBeginEditable name="TopAddstionalFunction" -->
	...
	mysql_select_db($database_conContinuty, $conContinuty); ?>
	<!-- TemplateBeginEditable name="CPUpdate" --><?php 
	//FIELD='".str_replace("'","''",$_POST['FIELDNAME'])."',
	//FIELD2='".str_replace("'","''",$_POST['FIELDNAME2'])."'
		
	mysql_query("UPDATE ".$row_rsPlans['TableName']." SET  WHERE UserID = ".$UserID, $conContinuty) or die(mysql_error()); ?><!-- TemplateEndEditable -->		    <?php 
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
              ...
              <h1><!-- InstanceBeginEditable name="h1Title" -->My Continuity Plans - <?php echo $strEdition; ?> Edition - ENTER SECTION NAME HERE<!-- InstanceEndEditable --></h1>
          	</div><!-- end of Header -->
		...
		<form action="<?php echo $Form; ?>" method="post" id="frmForm" class="frmBasics" enctype="multipart/form-data"> 
              <div class="customContainer" id="divFloatingMenuContainer">
                <div class="customContent" id="divFloatingMenuContent">
                	<div align="left">
			                <!-- TemplateBeginEditable name="PlanContent" --> 
                      ...
                      <div class="customNavigation" id="divFloatingMenuNavigation">
                        <div class="divFloat divBasicFloat">
                          ...
                          <div class="customFooter divFloatingMenuInsideFooter">
                                ...
                                <!-- TemplateBeginEditable name="FormButtonsSection" --><!-- TemplateEndEditable -->
                          </div>
                        </div>
                      </div>
