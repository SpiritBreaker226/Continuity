...
<title>RSA - Exclusive ENTER SECTION HERE - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- InstanceEndEditable -->
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
              ...
              <h1><!-- InstanceBeginEditable name="h1Title" -->RSA - Exclusive ENTER SECTION HERE<!-- InstanceEndEditable --></h1>
          	</div><!-- end of Header -->
            <div class="customContent" id="divBasicContent">
                ...
                <!-- TemplateBeginEditable name="RSAContent" -->
            ...
            <div class="customFooter" id="divBasicFooter" align="left">
			  <!-- InstanceBeginEditable name="BasicFooter" -->
				<!-- TemplateBeginEditable name="RSAFooter" --><!-- TemplateEndEditable -->
