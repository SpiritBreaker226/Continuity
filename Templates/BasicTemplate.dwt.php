...
<title>ENTER SECTION TITLE HERE - Continuity Inc. - Disaster Recovery Solutions</title>
<!-- TemplateEndEditable -->
	...
	<div align="center">
        <div class="customContainer" id="divBasicContainer">
            <div class="customHeader" id="divBasicHeader">
                ...
                <div class="customNavigation" id="divBasicHeaderNavigation" align="left">
                   <form action="<?php echo $loginFormAction; ?>" method="post" name="frmLogin" id="frmLogin" class="frmBasics">
					   ...
					   if($_GET['section'] != "")
						 ...
						 <!-- TemplateBeginEditable name="hiddenAreaForLogIn" --><!-- TemplateEndEditable -->
                        ...
                        if (checksUserID() !== FALSE)
                        {
							...
							else
							{
								...
								?><!-- TemplateBeginEditable name="hiddenAreaForLogOut" --><!-- TemplateEndEditable --><?php
							}//end of else
              ...
              <h1><!-- TemplateBeginEditable name="h1Title" -->ENTER SECTION NAME HERE<!-- TemplateEndEditable --></h1>
          	</div><!-- end of Header -->
            <div class="customContent" id="divBasicContent">
                <!-- TemplateBeginEditable name="BasicContent" -->
            ...
            <?php }//end of if ?>
            <div class="customFooter" id="divBasicFooter" align="left">
			  <!-- TemplateBeginEditable name="BasicFooter" -->
